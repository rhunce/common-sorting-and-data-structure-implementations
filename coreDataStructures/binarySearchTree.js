...
console.log("Test 10:", bST.getNodeAndParent(5).node.value === 5 ? "PASS" : "FAIL")
console.log("Test 11:", bST.getNodeAndParent(4).node.value === 4 ? "PASS" : "FAIL")
console.log("Test 12:", bST.getNodeAndParent(8).node.value === 8 ? "PASS" : "FAIL")
console.log("Test 13:", bST.getNodeAndParent(1).node.value === 1 ? "PASS" : "FAIL")
console.log("Test 14:", bST.getNodeAndParent(7).node.value === 7 ? "PASS" : "FAIL")
console.log("Test 15:", bST.getNodeAndParent(9).node.value === 9 ? "PASS" : "FAIL")
console.log("========== TESTS FOR inOrderTraversal ==========")
console.log("Test 16: ", JSON.stringify(bST.inOrderTraversal()) === JSON.stringify([1,2,3,4,5,6,7,8,9]) ? "PASS" : "FAIL")
console.log("========== TESTS FOR preOrderTraversal ==========")
console.log("Test 17: ", JSON.stringify(bST.preOrderTraversal()) === JSON.stringify([5,3,2,1,4,6,8,7,9]) ? "PASS" : "FAIL")
console.log("========== TESTS FOR postOrderTraversal ==========")
console.log("Test 18: ", JSON.stringify(bST.postOrderTraversal()) === JSON.stringify([1,2,4,3,7,9,8,6,5]) ? "PASS" : "FAIL")
console.log("========== TESTS FOR removeValue ==========")
const bST2 = BinarySearchTree.buildBST([1,0,2,3])
console.log("Test 19: ", JSON.stringify(bST2.preOrderTraversal()) === JSON.stringify([1,0,2,3]) ? "PASS" : "FAIL")
bST2.removeValue(3)
console.log("Test 20: ", JSON.stringify(bST2.preOrderTraversal()) === JSON.stringify([1,0,2]) ? "PASS" : "FAIL")
bST2.removeValue(0)
console.log("Test 21: ", JSON.stringify(bST2.preOrderTraversal()) === JSON.stringify([1,2]) ? "PASS" : "FAIL")
bST2.removeValue(2)
console.log("Test 22: ", JSON.stringify(bST2.preOrderTraversal()) === JSON.stringify([1]) ? "PASS" : "FAIL")
bST2.removeValue(1)
console.log("Test 23: ", bST2.root === null ? "PASS" : "FAIL")
const bST3 = BinarySearchTree.buildBST([5,4,3])
bST3.removeValue(4)
console.log("Test 24: ", JSON.stringify(bST3.preOrderTraversal()) === JSON.stringify([5,3]) ? "PASS" : "FAIL")
const bST4 = BinarySearchTree.buildBST([5,3,4])
bST4.removeValue(3)
console.log("Test 25: ", JSON.stringify(bST4.preOrderTraversal()) === JSON.stringify([5,4]) ? "PASS" : "FAIL")
bST4.removeValue(5)
console.log("Test 26: ", JSON.stringify(bST4.preOrderTraversal()) === JSON.stringify([4]) ? "PASS" : "FAIL")
const bST5 = BinarySearchTree.buildBST([5,6,7])
bST5.removeValue(6)
console.log("Test 27: ", JSON.stringify(bST5.preOrderTraversal()) === JSON.stringify([5,7]) ? "PASS" : "FAIL")
const bST6 = BinarySearchTree.buildBST([5,7,6])
bST6.removeValue(7)
console.log("Test 28: ", JSON.stringify(bST6.preOrderTraversal()) === JSON.stringify([5,6]) ? "PASS" : "FAIL")
bST6.removeValue(5)
console.log("Test 29: ", JSON.stringify(bST6.preOrderTraversal()) === JSON.stringify([6]) ? "PASS" : "FAIL")
const bST7 = BinarySearchTree.buildBST([70,60,55,65,66,64,63])
console.log("Test 30: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,60,55,65,64,63,66]) ? "PASS" : "FAIL")
bST7.removeValue(60)
console.log("Test 31: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,63,55,65,64,66]) ? "PASS" : "FAIL")
bST7.insertValue(68)
bST7.insertValue(67)
bST7.insertValue(69)
console.log("Test 32: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,63,55,65,64,66,68,67,69]) ? "PASS" : "FAIL")
bST7.removeValue(65)
console.log("Test 33: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,63,55,66,64,68,67,69]) ? "PASS" : "FAIL")
bST7.insertValue(54)
bST7.insertValue(56)
console.log("Test 34: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,63,55,54,56,66,64,68,67,69]) ? "PASS" : "FAIL")
bST7.removeValue(55)
console.log("Test 35: ", JSON.stringify(bST7.preOrderTraversal()) === JSON.stringify([70,63,56,54,66,64,68,67,69]) ? "PASS" : "FAIL")
